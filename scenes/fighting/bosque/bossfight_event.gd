...
func trigger():
	...
	yield(text_prompt([
		...
		"BIFE: porq???", 
		"TUTUJO: porque estoy cansado de los transeuntes que hacen bochinche, esta es mi casa, prohibido el paso", 
#		"BIFE: que es un transeunte?",
#		"TUTUJO: alguien que pasa",
		"BIFE: pero tu casa es el unico paso que conecta mi pueblo con un almacen",
		"BIFE: yo me levanto todos los dias a laburar, 9 a 6, para mantener a mi familia",
		...
		"BIFE: no no me dijiste",
		"TUTUJO: bueno te lo digo ahora",
		...
		"TUTUJO: decile a tu pelado que cague en el pasto",
		"BIFE: bue",
		"TUTUJO: date media vuelta porque empiezo a los cascotazos",
		"BIFE: mira, yo voy a pasar corriendo, me voy a ir, y hasta que no tenga que volver, nos vamos a olvidar que paso esto, OK?",
		"TUTUJO: a donde vas a ir?"
		]), "completed")
